$(document).ready(function() {
   ...
   $('.index-slider').slick({
    ...
    $('.m-silder').slick({
        ...
        // Add custom class to the center slide
        $('.slick-slide').removeClass('slick-center-focus');
        $('.slick-center').addClass('slick-center-focus');
    });
            ...
            $(document).ready(function(){
                $('.client-slider').slick({
                    ...
                    centerPadding: '20px', // Adjust padding to control the visibility of the side slides
                    dots: false,
                    arrows: true,
                    infinite: true,
                    speed: 300,
                    slidesToShow: 4, // Display 4 slides, including the center slide
                    slidesToScroll: 1,
                    autoplay: true,
                    autoplaySpeed: 2000,
                    responsive: [
                        {
                            breakpoint: 1024, // Adjust this breakpoint based on your design
                            settings: {
                                slidesToShow: 3,
                                slidesToScroll: 1,
                                centerMode: true,
            ...
            $('.event-slider').slick({
                ...
                autoplaySpeed: 2000,
                centerMode: true, // Enable center mode
                centerPadding: '10%', // Adjust as needed to show partial slides
                responsive: [
                    {
                        breakpoint: 825,
                        settings: {
                            ...
                            arrows: false,
                            centerMode: true, // Keep center mode on smaller screens
                            centerPadding: '20%', // Adjust as needed for smaller screens
                        }
                    },
                    {
                        breakpoint: 424,
